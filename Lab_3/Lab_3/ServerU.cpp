...
int main()
{
	...
	try
	{
		...
		{
			if (ibuf == "")	break;
			if (libuf = recvfrom(sS, ibuf, sizeof(ibuf), NULL, (sockaddr*)&clnt, &lenclnt) == SOCKET_ERROR)
				throw SetErrorMsgText("recvfrom:", WSAGetLastError());
			if ((lobuf = sendto(sS, ibuf, sizeof(ibuf), NULL, (sockaddr*)&clnt, sizeof(clnt))) == SOCKET_ERROR)
